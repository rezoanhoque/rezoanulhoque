...
This book is your guide to preparing for a career in Economics and Finance. In these fields, you need to be good at interpreting data and presenting it effectively. This book will help you build your data science and analytics skills and apply those to answer questions in the fields of Economics and Finance.

But it's not all about programming skills. We also delve into the world of economic indicators, offering insights into business cycles and regional differences in economic performance. You'll learn about traditional measures like GDP growth, inflation, money supply, and interest rates. But we also cover survey- and text-based indicators that have recently gained popularity. These include consumer confidence indices, forecaster data, real-time data, and text-based indicators of economic uncertainty. The latter is derived from language analysis of newspapers, social media posts, or Google searches.

If you work your way through this book, you'll be ready to analyze data on a wide range of economic and financial topics. Your learning progress will be assessed based on the completion of [DataCamp](https://www.datacamp.com){target="_blank"} courses and the production of three data reports.
...
[253 Holden Hall](http://www.ttu.edu/map/?b=Holden%20Hall) \
Lubbock, TX 79409


Website: [www.julianfludwig.com](https://www.julianfludwig.com/) \
...
kable(date_table, booktabs = TRUE, 
    ...
    row_spec(1:nrow(date_table), font_size = 11)
```
