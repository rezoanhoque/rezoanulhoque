...
&nbsp; &nbsp;&nbsp;&nbsp;
[![asdf](icons/rstudio.png){width=20%}](https://posit.co/products/open-source/rstudio/){target="_blank"}
&nbsp; &nbsp;&nbsp;&nbsp;
[![asdf](icons/pearsonmylab.png){width=25%}](https://mlm.pearson.com/northamerica/myeconlab/){target="_blank"}
&nbsp; &nbsp;&nbsp;&nbsp;
[![asdf](icons/blackboard.png){width=10%}](https://ttu.blackboard.com/){target="_blank"}
...
[![asdf](icons/datacampclassroom.png){width=40%}](https://www.datacamp.com/universities){target="_blank"}
